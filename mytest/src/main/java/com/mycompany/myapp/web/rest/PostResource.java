...
public class PostResource {
    ...
    public ResponseEntity<List<PostDTO>> getAllPosts(
        ...
        if ("attachgroup-is-null".equals(filter)) {
            log.debug("REST request to get all Posts where attachGroup is null");
            return new ResponseEntity<>(postService.findAllWhereAttachGroupIsNull(), HttpStatus.OK);
        }
