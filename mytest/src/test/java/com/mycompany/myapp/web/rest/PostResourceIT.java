...
class PostResourceIT {
    ...
    void getAllPosts() throws Exception {
        ...
        restPostMockMvc
            ...
            .andExpect(jsonPath("$.[*].contents").value(hasItem(Base64.getEncoder().encodeToString(DEFAULT_CONTENTS))))
    ...
    void getPost() throws Exception {
        ...
        restPostMockMvc
            ...
            .andExpect(jsonPath("$.contents").value(Base64.getEncoder().encodeToString(DEFAULT_CONTENTS)))
